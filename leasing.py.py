...
def get_companies_df(endpoint):
    ...
    for company in companies:
        if endpoint == "dynamics":
            ...
            #data_top_requests['phrase'] = company
...
def write_profiles_to_csv(df, endpoint, flag=True):
    """
    ...
    filename = f"{endpoint}_{date_now}.csv"
    df.to_csv(
...
if __name__ == '__main__':
    ...
    load_db(write_profiles_to_csv(get_companies_df(endpoints[2]), endpoints[2]))
#load_db("leasing__2026_05_05.csv")
